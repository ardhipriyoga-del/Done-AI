...
import { RefreshCw, Search, X, Clock, MapPin, Activity, Stethoscope, AlertCircle, ArrowRightLeft, ShieldCheck, CalendarDays } from 'lucide-react';
import { Badge } from '@/components/ui/badge';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@/components/ui/dialog';
import { toast } from 'sonner';
import { apiUrl, getApiBaseUrl, hasApiProxy } from '@/lib/apiConfig';
        ...
        <div className="space-y-3 py-1">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <p className="text-sm font-mono">{patient.episode || '—'}</p>
            </div>
            <div>
