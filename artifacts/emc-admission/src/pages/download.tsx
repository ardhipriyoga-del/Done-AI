    ...
    <div className="p-6 max-w-2xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm">
           ...
           Operating Theatre, Backup Cloud, Log Aktivitas (Audit Trail), dan Sinkronisasi TrakCare.
        ...
        <Card className="border-emerald-300/60 bg-emerald-50/60 dark:border-emerald-700/40 dark:bg-emerald-950/20">
          <CardContent className="p-5 flex flex-col sm:flex-row items-center gap-4">
            <div className="flex-1 space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Pengembangan ipaw.html · data kerja disimpan di LocalDB · Cloud hanya sebagai backup
              </p>
              <p className="text-xs text-muted-foreground">
                Tetap dapat digunakan saat internet terputus; backup otomatis dilanjutkan saat koneksi tersedia.
                Untuk Windows, gunakan launcher V2 di bawah.
              </p>
            </div>
