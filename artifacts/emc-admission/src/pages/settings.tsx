...
export default function SettingsPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      {activeTab === 'masterEstimasi' && isSuperuser && (
        <MasterEstimasiTindakanPanel importedBy={user?.namaLengkap || user?.username || 'Superuser'} />
      )}
