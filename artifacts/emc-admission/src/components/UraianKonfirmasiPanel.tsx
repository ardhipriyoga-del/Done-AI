...
function buildTemplateText(t: TemplateFormState): string {
  ...
  lines.push(`SUPLEMENT                  : ${t.suplemen}`);
  ...
  lines.push('');
  lines.push(`BATASAN KONFIRMASI OBT/LAB/RO :`);
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          <div className="space-y-1.5">
            <Label className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              8. Batasan Konfirmasi Obat / Lab / Radiology
            </Label>
            <Textarea
          ...
          {loading ? (
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
              ...
              <Card className="shadow-none border-border">
                <CardHeader className="py-2.5 px-4 bg-emerald-50 dark:bg-emerald-900/20 border-b border-border rounded-t-lg">
                  <CardTitle className="text-xs font-bold text-emerald-800 dark:text-emerald-300 uppercase tracking-wide">
                    Informasi Pasien
                  </CardTitle>
                </CardHeader>
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        className="h-7 text-xs gap-1.5 border-emerald-300 text-emerald-700 hover:bg-emerald-50 dark:border-emerald-600 dark:text-emerald-400"
                      >
